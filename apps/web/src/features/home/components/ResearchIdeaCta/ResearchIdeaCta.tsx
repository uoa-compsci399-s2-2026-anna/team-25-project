...
export const ResearchIdeaCta = () => {
  return (
    <div className="flex h-full flex-col justify-between gap-6 rounded-2xl bg-brand-blush/60 p-8">
      <div className="flex flex-col gap-4">
        <Heading level="h3">Have a research idea?</Heading>
        ...
        <ul className="flex flex-col gap-3">
          {benefits.map(({ icon: Icon, label }) => (
            <li className="flex items-center gap-2 text-muted-foreground text-sm" key={label}>
